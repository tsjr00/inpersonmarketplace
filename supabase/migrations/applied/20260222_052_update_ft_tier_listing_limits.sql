-- ============================================================================
-- Migration 052: Update FT tier listing limits in DB trigger
-- ============================================================================
-- Sync enforce_listing_tier_limit() with updated FT tier limits:
--   free:  4 → 5
--   basic: 8 → 10
-- Pro (20) and Boss (45) unchanged. FM limits unchanged.
-- ============================================================================
