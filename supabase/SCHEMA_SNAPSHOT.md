...
**Last Verified:** 2026-04-12 (Migrations 115–120 applied to all 3 envs. 116: `event_ratings`. 117: `error_logs.vertical_id`. 118: indexes+FK+CHECK. 119: company-paid fees+cap. 120: wave hardening — `expires_at` column, `reserve_event_wave` rewrite, `free_wave_on_order_cancel` + `recalculate_wave_capacity` RPCs.)
