...
| public     | vendor_profiles          | vendor_profiles_select           | PERMISSIVE | {public} | SELECT | (((status = 'approved'::vendor_status) AND (deleted_at IS NULL)) OR (user_id = ( SELECT auth.uid() AS uid)))                                                                                                                                                                                                     | null                                                                                                                                                                                                                                                                                 |
| public     | vendor_profiles          | vendor_profiles_update           | PERMISSIVE | {public} | UPDATE | (user_id = ( SELECT auth.uid() AS uid))                                                                                                                                                                                                                                                                          | null                                                                                                                                                                                                                                                                                 |
