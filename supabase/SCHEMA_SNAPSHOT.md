...
**Last Verified:** 2026-04-13 (Migration 122 hotfix: dropped 2 recursive organizer RLS policies from migration 121 that caused infinite recursion on markets for authenticated users. Browse and /api/cart restored.)
