...
**Last Verified:** 2026-04-12 (Migrations 115–119 applied to all 3 envs. 116: `event_ratings` table. 117: `vertical_id` on `error_logs`. 118: 7 indexes + FK + CHECK. 119: `create_company_paid_order` RPC rewrite (fees + cap) + `event_company_payment_id` on orders.)
