      ...
      try {
        const response = await fetch('/api/admin/reports', {
          ...
          body: JSON.stringify({
            ...
            dateFrom,
            dateTo,
            verticalId: selectedVertical !== 'all' ? selectedVertical : undefined
          })
        })
