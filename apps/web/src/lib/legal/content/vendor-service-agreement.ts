    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          {
            id: 'vendor-obligations-2.6',
            title: '2.6 Child-Safety Legal Compliance',
            level: 'section',
            content: [
              'Markets, events, and pickup locations arranged through the Platform may be located at or near schools, churches, daycare facilities, playgrounds, parks, and other places where children gather or are likely to gather.\n\n(a) Your Sole Responsibility. If you, or any owner, officer, employee, agent, contractor, or other member of your team, is subject to any legal prohibition, restriction, or registration requirement — including, without limitation, any requirement arising from sex-offender registration or similar status under any federal, state, or local law, court order, or condition of parole, probation, or supervised release — that prohibits or restricts that individual from being present at or near schools, churches, daycare facilities, playgrounds, or other places where children gather or are likely to gather, you are solely responsible for ensuring that such individual does not participate in, staff, attend, or otherwise be present at any market, event, or location arranged through the Platform where such presence would violate that prohibition or restriction.\n\n(b) No Company Duty to Screen. You acknowledge and agree that the Company has no duty to screen, monitor, investigate, or verify the legal status of you or any member of your team, and that compliance with this Section rests entirely with you and not with the Company.\n\n(c) Cooperation and Disclosure. If a violation or alleged violation of this Section is brought to the Company\'s attention, you agree to cooperate fully with any action the Company reasonably takes in response, and you consent to any disclosure the Company is required to make or reasonably deems necessary to make, including disclosure to event organizers, venue owners or operators, market managers, and law enforcement.\n\n(d) Remedies. Violation of this Section constitutes a material breach of this Agreement and grounds for immediate suspension or termination of your vendor account, in addition to any other remedy available to the Company.\n\n(e) Acknowledgment. By accepting this Agreement and by accepting any market or event agreement through the Platform, you acknowledge that you have read this Section, that you accept the responsibility it describes, and that this responsibility is yours and not the Platform\'s.',
            ],
          },
        ],
      },
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            level: 'section',
            content: [
              'The Company maintains records of all marketplace transactions, including sales amounts, tax amounts collected, tax rates applied, product classifications, and payout amounts, for at least as long as required by applicable federal and state law for each jurisdiction in which the Company operates. Retention periods may vary by state based on applicable tax and financial reporting requirements. You may access your transaction records through your vendor dashboard for the duration of your account, and you may request copies of historical records by contacting the Company through the Platform\'s support page.',
            ],
          },
        ],
      },
