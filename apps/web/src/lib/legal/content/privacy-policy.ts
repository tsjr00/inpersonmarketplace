  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        level: 'article',
        content: [
          '(a) Active Accounts: Personal information and account data are retained for as long as your account remains active;\n\n(b) Transaction Records: Records of transactions, payments, and payouts are retained for a minimum of seven (7) years for tax reporting, legal compliance, and dispute resolution purposes;\n\n(c) Deleted Accounts: Upon account deletion, personal information is anonymized (display name replaced, email removed, location data cleared). Anonymized transaction records may persist indefinitely for accounting and legal purposes;\n\n(d) System Logs: Error logs are retained for ninety (90) days. Notification records are retained for sixty (60) days. Public activity events expire after seven (7) days;\n\n(e) Vendor Agreement Records: Records of vendor agreement acceptances, including timestamps and IP addresses, are retained indefinitely to support enforcement of contractual obligations; and\n\n(f) Audit Logs: Records of administrative actions and data changes are retained indefinitely for security and compliance purposes.',
        ],
      },
      {
        id: 'privacy-security',
