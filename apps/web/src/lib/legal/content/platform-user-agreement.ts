      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            level: 'section',
            content: [
              'The Platform charges service fees to facilitate transactions and sustain Platform operations:\n\n(a) Buyer Service Fee: A platform fee of five percent (5%) of the order subtotal is included in the transaction amount for each order. This fee is incorporated into the displayed product prices on the Platform and covers Platform services, technology infrastructure, and transaction facilitation.\n\n(b) Card Processing Share: Buyers pay one-half of the card-processing cost for each order, tallied as one and one-half percent (1.5%) of the order subtotal (incorporated into displayed product prices) plus a flat fifteen cents ($0.15) per order displayed as a line item at checkout. The vendor pays the remaining half of the card-processing cost.\n\n(c) Small Order Fee: Orders below [SMALL_ORDER_THRESHOLD] may be subject to a small order fee of [SMALL_ORDER_FEE], displayed at checkout.\n\n(d) The Company reserves the right to modify fee rates upon thirty (30) days\' notice to active users. Updated fee rates will be reflected in product pricing and at checkout.',
            ],
          },
          {
            id: 'payment-terms-3',
