...
export const foodTrucksConfig: VerticalTerminologyConfig = {
  ...
  terminology: {
    ...
    market: 'Location',
    markets: 'Locations',
    traditional_market: 'Multi-Truck Location',
    traditional_markets: 'Multi-Truck Locations',
    private_pickup: 'Single Truck Location',
    private_pickups: 'Single Truck Locations',
    market_box: 'Chef Box',
    ...
    event_preference_unit_singular: 'cuisine',
    event_preference_unit_plural: 'cuisines',
    ...
    event_request_name_suffix: 'Private Event',
