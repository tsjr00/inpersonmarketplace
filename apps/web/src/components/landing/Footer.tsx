  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        // vertical-aware /[vertical]/market-manager-program page.
        ...((isFM || isFT) ? [{ label: t(isFT ? 'footer.park_operators' : 'footer.market_managers', locale), href: `/${vertical}/market-manager-program` }] : []),
      ]
    },
    {
