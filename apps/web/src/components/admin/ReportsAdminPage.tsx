...
const AVAILABLE_REPORTS: ReportOption[] = [
  ...
  { id: 'tax_list_supplement', name: 'Texas List Supplement (Form 01-116)', description: 'Sales tax COLLECTED per Texas jurisdiction code for the period, rolled up from the per-item snapshots frozen at checkout — the table the monthly return asks for. v1: items later cancelled or fully refunded are left out; partial-refund reversals arrive with the refund build. Empty until tax goes live.', category: 'accounting' },
