...
- **NEXT:** commit (clean batch: mig 168 + payments + route + D5 + UI + tests + snapshot/decision docs) → push staging → user tests redemption end-to-end → prod with the Item 4 push (apply 168 to prod AFTER 164–167, in the 9 PM–7 AM CT window).
