...
- **PHASE A COMPLETE** (A1 on staging · A2 local · A3 uncommitted). NEXT: Phase B plumbing (store-subtotal-NET; ⚠ checkout/session per-file approval; Q5/Q6 bounds questions) on owner go.
