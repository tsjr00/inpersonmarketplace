...
**PENDING:** NOT-2/NOT-5 (notification efficiency tail); backlog-tail pass (CHK-1 remainder, VOR-8, CRN-3+CRN-14, CRN-10, CHK-7+CRN-5); optional buyer lazy-survey sliver. Staging test of the whole train + combined prod push (migs 184→196 in order, 9 PM–7 AM CT).
