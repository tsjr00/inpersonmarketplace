...
- **BATCH 3 BUILT, GATES GREEN (tsc 0, vitest 1687/1687), UNCOMMITTED:** VOR-10 in reject (file-approved, hook verify-retried) + resolve-issue — maybeSingle + logError-on-missing-row for Stripe-paid, company_paid exempt (assumptions in backlog.md), resolve-issue Stripe block gated !company_paid. Ledger VOR-10 fixed.
