...
## 🔨 IN PROGRESS 2026-07-28 — staging-test fixes (Fix mode, UNCOMMITTED)
...
- **⏳ Extra #1 NOT BUILT (needs migration → approval):** second park image besides logo. MarketBrandingCard only handles markets.logo_url; a park cover/hero image needs a NEW markets column (migration), an upload route, + profile display. Flagged to user.
