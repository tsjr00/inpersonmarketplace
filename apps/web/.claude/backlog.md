...
| **T-42** ⬜ | **Unsubstituted `{vendorName}` placeholder in a live email** | Order-placed email to the buyer ends *"We will notify you when your order has been confirmed by {vendorName}."* — the literal token, sent to a real inbox. |
