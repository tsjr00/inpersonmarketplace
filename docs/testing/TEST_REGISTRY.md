...
| TR-022 | Stage surfaces agree: locations pill accepted ≠ Attending · organizer roster badges · admin chips · "Vendors who said yes: N of M" · dashboard "Locations & Schedule" card (P2–P5) | `/vendor/markets` events section · `/event-manager/[id]/dashboard` · `/[vertical]/admin/events` · `/vendor/events/[marketId]` | partial — dashboard PASS; public event page FAIL | 2026-09-15 owner — /event-manager/[id]/dashboard shows 'Said yes — pick or bench them' vs 'Selected' correctly; /[vertical]/events/[token] still says '3 Vendors attending' and lists the unselected vendor's products (the order page correctly hides them) | OB-024 |
