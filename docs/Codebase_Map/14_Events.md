...
8. **Treat `api/events/[token]/order/route.ts` and the wave stack as quarantined** — see [§ company-paid](#company-paid--deferred-and-non-executable). Do not reason about live money there.
