...
| `apps/web/.claude/rules/verification-discipline.md` | Cite the code, not your memory: cite-or-verify, schema mechanical gate, schema snapshot, data-first, schema-intent gate (read soft-delete + cascade signals before destructive CRUD), **structural/absence claims (grep proves presence ONLY — "only X"/"this is pure" needs an unfiltered read), and Rule 8: compress the MESSAGE, never the verification** | Sessions 63, 70, 73, 74, 83, 2026-08-08 |
